...
<div style="position:absolute; left:78px; top:315px; width:68px; height:150px; z-index:1">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=Istruzioni&PC=<?php echo isset($PC)?$PC:0;?>&istr=<?php echo isset($temp_Istruzione)?$temp_Istruzione:str_repeat("0",32);?>','','width=450,height=300');">
...
<div style="position:absolute; left:246px; top:434px; width:63px; height:25px; z-index:1">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=segno&dato=<?php echo $istruzione;?>&esteso=<?php echo isset($temp_ID_EX_imm)?(($temp_ID_EX_imm==0)?str_repeat('0',64):$temp_ID_EX_imm):str_repeat('0',64);?>','','width=400,height=230');">
...
<div style="position:absolute; left:825px; top:274px; width:60px; height:170px; z-index:1">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=memdati&memW=<?php echo substr($EX_MEM_WB,strlen($EX_MEM_WB)-(1));?>&memR=<?php echo substr($EX_MEM_WB,0,1);?>&ind=<?php echo isset($EX_MEM_RIS)?$EX_MEM_RIS:0;?>&DS=<?php echo isset($EX_MEM_DataW)?$EX_MEM_DataW:0;?>&DL=<?php echo isset($temp_MEM_WB_DataR)?$temp_MEM_WB_DataR:0;?>','','width=350,height=380');">
