...
<div>
  ...
  <div style="z-index:2" class="ex_mux1">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=ex_mux1&dato=<?php echo isset($ID_EX_WB)?$ID_EX_WB:0;?>&ex_scarta=<?php echo isset($EX_scarta)?$EX_scarta:0;?>','','width=350,height=225');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="EXECUTE MULTIPLEXER 1">
    </a>
  </div>

  <div style="z-index:2" class="ex_mux5">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=ex_mux5&op1=<?php echo isset($temp_ALUdato1)?$temp_ALUdato1:0;?>&op2=<?php echo isset($ID_EX_PC)?$ID_EX_PC:0;?>&ris=<?php echo isset($ALUdato1)?$ALUdato1:0;?>&ctrl=<?php echo isset($Mux5Ctrl)?$Mux5Ctrl:0;?>','','width=400,height=225');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="EXECUTE MULTIPLEXER 5">
    </a>
  </div>

  <div style="z-index:2" class="ex_mux6">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=ex_mux6&op1=<?php echo isset($temp_EX_MEM_DataW)?$temp_EX_MEM_DataW:0;?>&op2=<?php echo isset($ID_EX_immVal)?$ID_EX_immVal:0;?>&ris=<?php echo isset($ALUdato2)?$ALUdato2:0;?>&ctrl=<?php echo isset($Mux6Ctrl)?$Mux6Ctrl:0;?>','','width=400,height=225');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="EXECUTE MULTIPLEXER 6">
    </a>
  </div>

  <div style="z-index:2" class="id_mux2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=id_mux2&op1=<?php echo isset($branchAddr)?$branchAddr:0;?>&op2=<?php echo isset($jalrAddr)?$jalrAddr:0;?>&ris=<?php echo isset($jumpAddr)?$jumpAddr:0;?>&ctrl=<?php echo isset($isJalr)?(int)$isJalr:0;?>','','width=380,height=215');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="EXECUTE MULTIPLEXER 5">
    </a>
  </div>
  ...
  <div style="z-index:2" class="memdati">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=memdati&memW=<?php echo isset($EX_MEM_M)?substr($EX_MEM_M,1,1):0;?>&memR=<?php echo isset($EX_MEM_M)?substr($EX_MEM_M,0,1):0;?>&ind=<?php echo isset($EX_MEM_RIS)?$EX_MEM_RIS:0;?>&DS=<?php echo isset($EX_MEM_DataW)?$EX_MEM_DataW:0;?>&DL=<?php echo isset($MEM_WB_DataR)?$MEM_WB_DataR:0;?>','','width=350,height=365');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="DATA MEMORY">
    </a>
  </div>

  <div style="z-index:2" class="wb_mux">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=wb_mux&DL=<?php echo isset($MEM_WB_DataR)?$MEM_WB_DataR:0;?>&DC=<?php echo isset($MEM_WB_Data)?$MEM_WB_Data:0;?>&ctrl=<?php echo isset($MEM_WB_WB)?substr($MEM_WB_WB,strlen($MEM_WB_WB)-(1)):0;?>&WBdata=<?php echo isset($WBdata)?$WBdata:0;?>','','width=400,height=225');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="WRITE BACK MULTIPLEXER">
    </a>
  </div>

  <div style="z-index:2" class="id_som1">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=id_som1&ifidPC=<?php echo isset($IF_ID_PC)?$IF_ID_PC:0;?>&immsl=<?php echo isset($tempImm)?$tempImm*2:0;?>&output=<?php echo isset($branchAddr)?$branchAddr:0;?>','','width=300,height=180');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="ADDER 2">
    </a>
  </div>

  <div style="z-index:2" class="id_som2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=id_som2&imm=<?php echo isset($tempImm)?$tempImm:0;?>&rs1=<?php echo isset($temp_ID_EX_Data1)?$temp_ID_EX_Data1:0;?>&output=<?php echo isset($jalrAddr)?$jalrAddr:0;?>','','width=300,height=180');">
    <img src="../img/layout/x.gif" width="100%" height="100%" border="0" alt="ADDER 3">
    </a>
  </div>

  <div style="z-index:2" class="sl1">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=sl1&input=<?php echo isset($tempImm)?GMPToBin($tempImm,$_SESSION['XLEN'],0):str_repeat('0',$_SESSION['XLEN']);?>&output=<?php echo isset($tempImm)?GMPToBin($tempImm*2,$_SESSION['XLEN'],0):str_repeat('0',$_SESSION['XLEN']);?>','','width=400,height=190');">
  ...
  <div class="if_id if_id_latch" style="width:40px; height:293px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=ifid','','width=350,height=110');">
  ...
  <div class="id_ex id_ex_latch" style="width:40px; height:412px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=idex','','width=350,height=110');">
  ...
  <div class="ex_mem ex_mem_latch" style="width:40px; height:376px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=exmem','','width=350,height=110');">
  ...
  <div class="mem_wb mem_wb_latch" style="width:40px; height:346px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=memwb','','width=350,height=110');">
  ...
  <div class="id_ex id_ex_wb" style="width:40px; height:35px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=idexwb&dataIn=<?php echo isset($ctrl_WB)?$ctrl_WB:str_repeat('0',2);?>&dataOut=<?php echo isset($ID_EX_WB)?$ID_EX_WB:str_repeat('0',2);?>','','width=290,height=165');">
  ...
  <div class="id_ex id_ex_mem" style="width:40px; height:35px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=idexmem&dataIn=<?php echo isset($ctrl_M)?$ctrl_M:str_repeat('0',5);?>&dataOut=<?php echo isset($ID_EX_M)?$ID_EX_M:str_repeat('0',5);?>','','width=290,height=170');">
  ...
  <div class="id_ex id_ex_ex" style="width:40px; height:35px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=idexex&dataIn=<?php echo isset($ctrl_EX)?$ctrl_EX:str_repeat('0',6);?>&dataOut=<?php echo isset($ID_EX_EX)?$ID_EX_EX:str_repeat('0',6);?>','','width=290,height=165');">
  ...
  <div class="ex_mem ex_mem_wb" style="width:40px; height:35px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=exmemwb&dataIn=<?php echo isset($ID_EX_WB)?$ID_EX_WB:str_repeat('0',2);?>&dataOut=<?php echo isset($EX_MEM_WB)?$EX_MEM_WB:str_repeat('0',2);?>','','width=290,height=165');">
  ...
  <div class="ex_mem ex_mem_mem" style="width:40px; height:35px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=exmemmem&dataIn=<?php echo isset($ID_EX_M)?$ID_EX_M:str_repeat('0',5);?>&dataOut=<?php echo isset($EX_MEM_M)?$EX_MEM_M:str_repeat('0',5);?>','','width=290,height=170');">
  ...
  <div class="mem_wb mem_wb_wb" style="width:40px; height:35px; z-index:2">
    <a href="javascript:void(0);" onclick="javascript:window.open('elements.php?el=memwbwb&dataIn=<?php echo isset($EX_MEM_WB)?$EX_MEM_WB:str_repeat('0',2);?>&dataOut=<?php echo isset($MEM_WB_WB)?$MEM_WB_WB:str_repeat('0',2);?>','','width=290,height=165');">
