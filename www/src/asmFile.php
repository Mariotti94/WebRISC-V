...
if ($_SESSION['branchRes']==0) {
  switch ($cosa)
  {
    ...
    case "hazard":
      ...
      $codice=$codice.'addi t0, x0, 1'.PHP_EOL;
      $codice=$codice.'addi t1, x0, 2'.PHP_EOL;
      $codice=$codice.'# Hazard M=>X && X=>X:'.PHP_EOL;
      $codice=$codice.'add t2, t0, t1'.PHP_EOL;
      $codice=$codice.'# Hazard X=>X:'.PHP_EOL;
      $codice=$codice.'add t3, t0, t2'.PHP_EOL;
      $codice=$codice.'# Hazard M=>X:'.PHP_EOL;
      $codice=$codice.'add t4, t0, t2';
      $_SESSION['codice']=$codice;
      $_SESSION['asmName']=$cosa.'.s';
      header('Location: editor.php');
      break;
