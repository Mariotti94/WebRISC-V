  ...
  <script language='JavaScript' type='text/JavaScript'>
    function resizeFit() {
      if(top.frames[0].document.querySelector('table').offsetWidth > window.innerWidth) {
        ...
        top.document.querySelector('frameset').setAttribute('rows','130,*');
      }
    };
    ...
    if (window.mobilecheck()) {
      window.onload = function() {
        top.frames[0].document.body.setAttribute('style','background: #f0f0f0; overflow: hidden!important;');
      };
    }
    else {
...
<frameset rows="130,*" frameborder="no" border="0" framespacing="0">
  <frame src="src/header.php" name="Header" scrolling="yes" noresize="">
